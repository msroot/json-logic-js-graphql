...
;(0, _mocha.describe)('Custom operators', function () {
  ;(0, _mocha.describe)('Custom', function () {
    ;(0, _mocha.it)('nonZeroMin', function () {
      var logic = {
        _nonZeroMin: [[100, 0, 30]],
      }
      ;(0, _chai.expect)(_index.jsonLogic.apply(logic)).to.be.equal(30)
    })
    ;(0, _mocha.it)('nonZeroMax', function () {
      var logic = {
        _nonZeroMax: [[100, 0, 30]],
      }
      ;(0, _chai.expect)(_index.jsonLogic.apply(logic)).to.be.equal(100)
    })
  })
})
;(0, _mocha.describe)('Moment operators', function () {
  ;(0, _mocha.describe)('Dates', function () {
    ;(0, _mocha.it)('_isPastDate', function () {
      var rules = {
        _isPastDate: [
          {
            var: 'date',
    ...
    ;(0, _mocha.it)('_isFutureDate', function () {
      var rules = {
        _isFutureDate: [
          {
            var: 'date',
